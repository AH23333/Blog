...
console.log('class="mermaid" count:', (c.match(/class="mermaid"/g) || []).length);
console.log("data-has-mermaid count:", (c.match(/data-has-mermaid/g) || []).length);
console.log("");

console.log("=== Lazy Loading Check ===");
console.log("lazy-initial-content:", (c.match(/lazy-initial-content/g) || []).length);
console.log("lazy-chunk-initial:", (c.match(/lazy-chunk-initial/g) || []).length);
...
console.log("textmode-pre phile-body:", (c.match(/textmode-pre phile-body/g) || []).length);
