...
| ![结果卡片](Blog\public\images\volume-2\primary-work\StarMark\03-result-card.png) | ![地址栏建议](Blog\public\images\volume-2\primary-work\StarMark\04-omnibox.png) |
| **03 · 结果卡片**：标签 / 笔记 / 置顶 / 右键菜单 | **04 · 地址栏建议**：`st` 关键字直接呼出 |
| ![标签云](Blog\public\images\volume-2\primary-work\StarMark\05-tags-cloud.png) | ![动态时间线](Blog\public\images\volume-2\primary-work\StarMark\06-activity.png) |
| **05 · 标签云**：频次统计，点击即筛 | **06 · 动态时间线**：Star / 书签增删轨迹 |
| ![批量操作](Blog\public\images\volume-2\primary-work\StarMark\07-batch-mode.png) | ![热榜推荐](Blog\public\images\volume-2\primary-work\StarMark\08-trending.png) |
| **07 · 批量多选 + 导出**：加标签 / 隐藏 / 删除 | **08 · 热榜推荐**：日 / 周 / 月，一键 Star |
| ![浅色主题](Blog\public\images\volume-2\primary-work\StarMark\09-light-mode.png) | ![设置页](Blog\public\images\volume-2\primary-work\StarMark\10-settings.png) |
| **09 · 浅色主题**：全界面深浅色随主题切换 | **10 · 设置页 · 账号与同步**：锚点导航 + Token 管理 |
| ![AI 整理与规则](Blog\public\images\volume-2\primary-work\StarMark\11-ai-rules.png) | ![数据与外观](Blog\public\images\volume-2\primary-work\StarMark\12-settings-data-theme.png) |
